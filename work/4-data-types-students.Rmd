...
- More opportunities to learn
    - [Data Wrangling with R](http://boot.rdata.work/bana_datawrangling) class 
    - [Dealing with Characters](http://boot.rdata.work/characters) tutorial
    - [Dealing with Regular Expressions](http://boot.rdata.work/regex) tutorial
