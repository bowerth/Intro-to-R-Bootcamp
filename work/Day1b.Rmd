...
Four primary structures to hold your data:
...
## What to Remember from this Section  | Know how to manage these structures
...
# 1. What is the min, max, median, and mean number of friends?
summary(fc)
...
```{r, collapse=TRUE, cache=TRUE, cache=TRUE}
# 1. Subset this fc vector to find individuals with more than 4,600 friends
Q1 <- fc[fc > 4600]
...
```{r, collapse=TRUE, cache=TRUE, fig.align='center', fig.width=6, fig.height=3, message=FALSE, warning=FALSE}
fb_model <- lm(friend_count ~ gender + age, data = facebook)
...
We'll cover data frame summarization in more detail during the [Transforming your data with dplyr session]()
...
<font size="6">1. **Import** the `reddit` data located at<br><br> &nbsp;&nbsp;&nbsp;&nbsp;[https://bowerth.github.io/public/../data/reddit.csv](https://bowerth.github.io/public/../data/reddit.csv)</font><br><br><br>
...
```{r, collapse=TRUE, cache=TRUE, eval=FALSE}
# 1. Import the reddit data located at https://bowerth.github.io/public/../data/reddit.csv
url <- "https://bowerth.github.io/public/../data/reddit.csv"
reddit <- read.csv(url)
